...
fun getCppQuestions(
    ...
    return listOf(
        ...
        cppQuestion(
            ...
            listOf("<stdio.h>", "<input>", "<stream>", "<iostream>"),
            "<iostream>",
        ...
        cppQuestion(
            ...
            listOf( "static", "final", "const", "define"),
            "const",
        ...
        cppQuestion(
            ...
            listOf("break", "exit", "return", "continue"),
            "return",
        ...
        cppQuestion(
            ...
            listOf( "break", "skip", "continue", "pass"),
            "continue",
        ...
        cppQuestion(
            ...
            listOf("include", "import", "scope", "using"),
            "using",
        ...
        cppQuestion(
            ...
            listOf( "boolean", "truefalse", "bool", "bit"),
            "bool",
    ...
    cppQuestion(
        ...
        options = listOf( "then", "false", "continue", "else"),
        correctAnswer = "else",
    ...
    cppQuestion(
        ...
        options = listOf("break", "continue", "exit", "stop"),
        correctAnswer = "break",
    ...
    cppQuestion(
        ...
        options = listOf("do-while", "for", "all of these", "while"),
        correctAnswer = "while",
    ...
    cppQuestion(
        ...
        options = listOf("if-else-if", "if", "switch", "for"),
    ...
    cppQuestion(
        ...
        options = listOf("do-while", "goto", "switch", "while"),
        correctAnswer = "while",
    ...
    cppQuestion(
        ...
        options = listOf("if", "loop", "switch",  "case"),
        correctAnswer = "loop",
    ...
    cppQuestion(
        ...
        listOf("static",  "virtual", "const", "inline"),
        "inline",
    ...
    cppQuestion(
        ...
        listOf("Inline", "Recursive", "Static", "main()"),
        "main()",
    ...
    cppQuestion(
        ...
        listOf("Functions", "Loops", "Arrays",  "Pointers"),
        "Functions",
    ...
    cppQuestion(
        ...
        listOf("Recursion", "Overloading", "Inline", "Abstraction"),
        "Recursion",
    ...
    cppQuestion(
        ...
        listOf("public", "protected","private", "default"),
        "private",
    ...
    cppQuestion(
        ...
        listOf("static", "inline", "const", "virtual"),
        "virtual",
    ...
    cppQuestion(
        ...
        listOf("Base class", "Parent class", "Main class", "Derived class"),
        "Derived class",
    ...
    cppQuestion(
        ...
        listOf("scope resolution", "virtual", "override", "friend"),
        "scope resolution",
    ...
    cppQuestion(
        ...
        listOf("Yes", "Only copy constructors", "Only default constructors", "No"),
        "No",
